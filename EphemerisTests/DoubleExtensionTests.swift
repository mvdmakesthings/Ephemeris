    ...
    $0.describe("Double Extension") {
        ...
        $0.context("rounding") {
            $0.it("rounds to zero places") {
                let value = 3.14159
                _ = try expect(value.round(to: 0)) == 3.0
            }
            
            $0.it("rounds to two places") {
                let value = 3.14159
                _ = try expect(value.round(to: 2)) == 3.14
            }
            
            $0.it("rounds to five places") {
                let value = 3.14159265359
                _ = try expect(value.round(to: 5)) == 3.14159
            }
            ...
            $0.it("rounds zero") {
                let value = 0.0
                _ = try expect(value.round(to: 5)) == 0.0
            }
        }
